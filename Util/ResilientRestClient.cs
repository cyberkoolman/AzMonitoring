...
namespace ResourceHealthAlertPOC.Util
{
    public class ResilientRestClient
    {
        ...
        //private static readonly CosmosClient client = new CosmosClient(Environment.GetEnvironmentVariable("CosmosDb_Uri", EnvironmentVariableTarget.Process), Environment.GetEnvironmentVariable("CosmosDb_Uri", EnvironmentVariableTarget.Process)("\"));
